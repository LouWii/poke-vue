...
export const dbtablePokemonStat               = dbTablePrefix + 'pokemonstat'
export const dbtablePokemonType               = dbTablePrefix + 'pokemontype'
export const dbtableStat                      = dbTablePrefix + 'stat'
export const dbtableStatName                  = dbTablePrefix + 'statname'
